...
import com.hyf.openapi.interfaces.exception.MyException;
import com.hyf.openapi.interfaces.security.AesEncryption;
...
public class MethodArgsUtil
{
	...
	public static MethodArgs checkPostMethodData(Map<String,Object> postdata) throws Exception
	{
		...
		catch (Exception e)
		{
			...
			else throw new MyException(-1, "检查方法名称、服务名称、参数数据,并返回对象失败." + e.getMessage());
		}
	}
